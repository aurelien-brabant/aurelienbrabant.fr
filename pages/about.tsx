  ...
  return (
    ...
    >
      ...
      >
        ...
        />
        <p>
          Hi, my name is Aurélien. I'm a french student currently studying software engineering at school 42 in Paris.
        </p>
        <p>
        ...
        <p>
          About programming in general, I'm mostly studying fundamentals at 42, making use of mainly C, C++ and even assembly.
          Nonetheless, I'm also really interested in web development, especially in TypeScript and NodeJS, which
          this website is made out of!
        </p>

        <p>
          Moreover, I enjoy quite a lot the GNU/Linux ecosystem, and love hearing about open source
          software: I'm indeed using Linux as my daily driver since almost the beginning of my programming journey!
        </p>
       ...
       with the hope that my knowledge may become
        ...
        <p>
          My so-called life plan is to continue working on software engineering projects, while traveling the world (the dream of every software engineer, yes I know!)
        </p>

        <p>A suggestion, question, offer? Feel free to{" "}
