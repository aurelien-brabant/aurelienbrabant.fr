...
const CareerItem: React.FC<{
...
}> = ({ title, imageAlt, imageUrl, startDateString, endDateString}) => {
	return (
	<div
	...
	>
		...
		<div>
		<h4>{title}</h4>
		<h5>{`${startDateString} - ${endDateString}`}</h5>
		</div>
	</div>
	);
}
    ...
    <React.Fragment>
      ...
      >
		...
		<div className={styles.introduction}>
			...
			<h3>
			  I make websites and write about programming and GNU/Linux stuff
			</h3>
			...
			<a href="https://42.fr" target="_blank">42 Paris</a>
			, where I mainly concentrate on C and C++ programming.
			I'm also building blazing fast, modern and reliable websites using{" "}
			...
			>
						<a href='https://twitter.com/aurelienb42' target="_blank" rel="noreferrer">
							<svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><title>Twitter</title><path d="M23.953 4.57a10 10 0 01-2.825.775 4.958 4.958 0 002.163-2.723c-.951.555-2.005.959-3.127 1.184a4.92 4.92 0 00-8.384 4.482C7.69 8.095 4.067 6.13 1.64 3.162a4.822 4.822 0 00-.666 2.475c0 1.71.87 3.213 2.188 4.096a4.904 4.904 0 01-2.228-.616v.06a4.923 4.923 0 003.946 4.827 4.996 4.996 0 01-2.212.085 4.936 4.936 0 004.604 3.417 9.867 9.867 0 01-6.102 2.105c-.39 0-.779-.023-1.17-.067a13.995 13.995 0 007.557 2.209c9.053 0 13.998-7.496 13.998-13.985 0-.21 0-.42-.015-.63A9.935 9.935 0 0024 4.59z" /></svg>
						</a>
						<a href="https://github.com/aurelien-brabant" target="_blank" rel="noreferrer">
						...
						<a href="https://www.linkedin.com/in/aurelien-brabant" target="_blank" rel="noreferrer">
		...
		<div className={styles.introductionCurve}>
			<svg data-name="Layer 2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 120" preserveAspectRatio="none">
		        <path d="M322.39,56.44c58-10.79,114.16-30.13,172-41.86,82.39-16.72,168.19-17.73,250.45-.39C823.78,31,906.67,72,985.66,92.83c70.05,18.48,146.53,26.09,214.34,3V0H0V27.35A600.21,600.21,0,0,0,321.39,56.44Z" className={styles.shapeFill}></path>
			 </svg>
		</div>
	  ...
	  <Container
	  className={styles.backgroundCareer}
	  limitedWidth={false}
	  >
      ...
      <Container className={styles.technologiesContainer}>
        ...
        >
          ...
          <Link href="/soon"><a>{"Let's get in touch!"}</a></Link>
        </div>
      </Container>
